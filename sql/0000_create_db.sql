CREATE DATABASE [Watchdog]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Watchdog', FILENAME = N'D:\mssql\Watchdog.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Watchdog_log', FILENAME = N'D:\mssql\Watchdog_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 WITH LEDGER = OFF
GO
ALTER DATABASE [Watchdog] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [Watchdog] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
GO
ALTER DATABASE [Watchdog] SET  DISABLE_BROKER 
GO
...
GO
ALTER DATABASE [Watchdog] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Watchdog] SET DELAYED_DURABILITY = DISABLED 
GO
USE [Watchdog]
GO
...
USE [Watchdog]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [Watchdog] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
